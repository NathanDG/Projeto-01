...
void algebra()
{
    ...
    do
    {
        ...
        printf("\n"YELLOW"============================================================\n");
        printf("|-----------------Digite a espressão:----------------------"RESET"|\n");
        printf("============================================================\n");

        printf("============================================================\n");
        printf("|"YELLOW"! = NOT | * = AND | + = OR | EX: a*b*c*!(a*b+!c*(b*c+a*c))"RESET"|\n");
        printf("============================================================\n\n");
    ...
    printf("\nResultado = ");
    if(expressao[0] == '1')
    printf(""GREEN"%c - (Verdadeiro)/(Ligado)"RESET"",expressao[0]);
    else
    printf(""RED"%c (Falso)/(Desligado)"RESET"",expressao[0]);
    printf("\n\n");
